sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/ControlTask_Leshkovich_Alexey/app", ".html");
		...
		return Opa5.extend("zjblessons.ControlTask_Leshkovich_Alexey.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/ControlTask_Leshkovich_Alexey/localService/mockserver"], function (mockserver) {
